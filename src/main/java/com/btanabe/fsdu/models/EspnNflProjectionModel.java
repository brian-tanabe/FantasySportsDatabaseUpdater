...
public class EspnNflProjectionModel {
    ...
    @Override
    public int hashCode() {
        String hashString = playerId + rank + name + team + position + passingCompletions + passingAttempts + passingYards + passingTouchdowns + interceptions + rushingAttempts + rushingYards + rushingTouchdowns + receptions + receivingYards + receivingTouchdowns + fantasyPoints;
