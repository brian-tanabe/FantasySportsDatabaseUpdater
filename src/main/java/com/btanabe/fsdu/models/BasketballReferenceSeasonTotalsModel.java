...
public class BasketballReferenceSeasonTotalsModel {
    ...
    public String toString() {
        return String.format("name=[%s], team=[%s], gamesStarted=[%d], gamesPlayed=[%d], minutesPlayed=[%d], fieldGoalsMade=[%d], fieldGoalsAttempted=[%d], fieldGoalPercentage=[%f], threePointersMade=[%d], threePointersAttempted=[%d], threePointPercentage=[%f], twoPointersMade=[%d], twoPointersAttempted=[%d], twoPointPercentage=[%f], effectiveFieldGoalPercentage=[%f], freeThrowsMade=[%d], freeThrowsAttempted=[%d], freeThrowPercentage=[%f], offensiveRebounds=[%d], defensiveRebounds=[%d], totalRebounds=[%d], assists=[%d], steals=[%d], blocks=[%d], turnovers=[%d], points=[%d], personalFouls=[%d]", name, team, gamesStarted, gamesPlayed, minutesPlayed, fieldGoalsMade, fieldGoalsAttempted, fieldGoalPercentage, threePointersMade, threePointersAttempted, threePointPercentage, twoPointersMade, twoPointersAttempted, twoPointPercentage, effectiveFieldGoalPercentage, freeThrowsMade, freeThrowsAttempted, freeThrowPercentage, offensiveRebounds, defensiveRebounds, totalRebounds, assists, steals, blocks, turnovers, points, personalFouls);
    }
