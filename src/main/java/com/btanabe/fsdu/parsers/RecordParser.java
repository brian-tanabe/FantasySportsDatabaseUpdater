...
public class RecordParser<OutputClazz> implements Function<String, OutputClazz> {
    ...
    public OutputClazz apply(String inputHtml) {
        ...
        setterMethodNamesMappedToValueExtractors.entrySet().parallelStream().forEach(setterMethodNameAndItsValueExtractor -> setterMethodNamesMappedToValues.put(setterMethodNameAndItsValueExtractor.getKey(), setterMethodNameAndItsValueExtractor.getValue().apply(inputHtml)));
